<template>
  ...
  >
    <p v-if="activeKey === 'tab1'" @nextStep="nextStep" :data1="data1">
      <VisitAnalysis @nextStep="nextStep" :data1="data1" :data2="data2" :data3="data3" />
    </p>
    <p v-if="activeKey === 'tab2'" @nextStep="nextStep" :data1="data1">
      <VisitAnalysis @nextStep="nextStep" :data1="data1" :data2="data4" :data3="data5" />
    </p>
    <p v-if="activeKey === 'tab3'" @nextStep="nextStep" :data1="data1">
      <VisitAnalysis @nextStep="nextStep" :data1="data1" :data2="data6" :data3="data7" />
    </p>
    <p v-if="activeKey === 'tab4'" @nextStep="nextStep" :data1="data1">
      <VisitAnalysis @nextStep="nextStep" :data1="data1" :data2="data8" :data3="data9" :data4="data10" />
    </p>
    <p v-if="activeKey === 'tab5'" @nextStep="nextStep" :data1="data1">
      <VisitAnalysis @nextStep="nextStep" :data1="data1" :data2="data11" :data3="data12" />
    </p>
    <p v-if="activeKey === 'tab6'" @nextStep="nextStep" :data1="data1">
      <VisitAnalysis @nextStep="nextStep" :data1="data1" :data2="data13" :data3="data14" />
    </p>
  </Card>
</template>
<script lang="ts">
  ...
  import { GetDeviceDataInfo } from '/@/api/sys/user';
    ...
    setup(props) {
      ...
      const openPages = async () => {
        if (JSON.stringify(route.query) !== '{}') {
          userdeviceInfo = await GetDeviceDataInfo();
          ...
          for (const key in vistitDeviceData) {
            ...
            dataA1.push(initialValue['ctime']);
